            ...
            {profile.missaoCorreta && (
              <div className="bg-fmb-army/10 border border-fmb-gold/30 rounded p-2.5 mt-2 max-w-md text-left font-mono">
                ...
                <span 
                  ...
                  className="text-xs text-white font-bold select-all bg-fmb-black/45 px-2 py-1 rounded block mt-1 border border-fmb-army/15 cursor-pointer hover:border-fmb-gold/45 transition-colors" 
